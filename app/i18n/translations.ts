export const translations = {
  uk: {
    ...
    calculation: {
      ...
      temperatureRange: 'Діапазон температур для розрахунку',
      minTemperature: 'Мінімальна температура (°C)',
      maxTemperature: 'Максимальна температура (°C)',
  ...
  en: {
    ...
    calculation: {
      ...
      temperatureRange: 'Temperature range for calculation',
